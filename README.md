...
AWS zero to hero repo for devops engineers to learn AWS in 30 Days. This repo includes projects, presentations, interview questions and real time examples. Each day's class will provide real-time knowledge on AWS services, allowingto apply what you've learned and gain practical skills in working with AWS in a DevOps context.
